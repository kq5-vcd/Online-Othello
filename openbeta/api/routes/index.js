...
router.post('/search', (req, res) => {
  const recv = { message: req.body.message, name: req.body.name }
  let tmp = ''

  console.log('Recv: ' + recv.message + ' - ' + recv.name)

  client.write(recv.message + ' ' + recv.name)
...
router.post('/bot', (req, res) => {
  const recv = { message: req.body.message, difficulty: req.body.difficulty }

  let tmp = ''
  client.write(recv.message + ' ' + recv.difficulty)
...
router.post('/getBotMove', (req, res) => {
  const recv = { message: req.body.message, roomID: req.body.roomID, move_row: req.body.move_row, move_col: req.body.move_col}
...
router.post('/quitBotGame', (req, res) => {
  const recv = {message: req.body.message}
